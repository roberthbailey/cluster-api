...
type MachineClassInterface interface {
	...
	UpdateStatus(*v1alpha1.MachineClass) (*v1alpha1.MachineClass, error)
...
func (c *machineClasses) UpdateStatus(machineClass *v1alpha1.MachineClass) (result *v1alpha1.MachineClass, err error) {
	result = &v1alpha1.MachineClass{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machineclasses").
