...
func (c *FakeMachineClasses) UpdateStatus(machineClass *v1alpha1.MachineClass) (*v1alpha1.MachineClass, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(machineclassesResource, "status", c.ns, machineClass), &v1alpha1.MachineClass{})
